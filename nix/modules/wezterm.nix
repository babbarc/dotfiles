{ ... }:
{
  ...
  # KevinSilvester/wezterm-config framework, not part of this repo. These 6 files
  ...
  # re-run `git update-index --skip-worktree config/*.lua` on these 6 paths and
  ...
  xdg.configFile = {
    ...
    "wezterm/config/env.lua".source = ../../wezterm/config/env.lua;
