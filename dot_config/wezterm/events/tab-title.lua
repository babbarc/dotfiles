...
-- Modified: colors retimed from catppuccin-mocha to rose-pine-moon (see inline comment).
...
-- Retimed from upstream's hardcoded catppuccin-mocha hexes to the rose-pine-moon
-- palette (base/overlay/muted/iris/gold/foam/love/text) that config/appearance.lua
-- actually sets as color_scheme, so the tab bar no longer clashes with the terminal.
---@type table<string, Cells.SegmentColors>
-- stylua: ignore
local colors = {
   text_default          = { bg = '#393552', fg = '#232136' },
   text_hover            = { bg = '#6e6a86', fg = '#232136' },
   text_active           = { bg = '#c4a7e7', fg = '#232136' },

   unseen_output_default = { bg = '#393552', fg = '#f6c177' },
   unseen_output_hover   = { bg = '#6e6a86', fg = '#f6c177' },
   unseen_output_active  = { bg = '#c4a7e7', fg = '#f6c177' },

   scircle_default       = { bg = 'rgba(0, 0, 0, 0.4)', fg = '#393552' },
   scircle_hover         = { bg = 'rgba(0, 0, 0, 0.4)', fg = '#6e6a86' },
   scircle_active        = { bg = 'rgba(0, 0, 0, 0.4)', fg = '#c4a7e7' },

   progress_percentage_default    = { bg = '#393552', fg = '#9ccfd8' },
   progress_percentage_hover      = { bg = '#6e6a86', fg = '#9ccfd8' },
   progress_percentage_active     = { bg = '#c4a7e7', fg = '#9ccfd8' },

   progress_error_default         = { bg = '#393552', fg = '#eb6f92' },
   progress_error_hover           = { bg = '#6e6a86', fg = '#eb6f92' },
   progress_error_active          = { bg = '#c4a7e7', fg = '#eb6f92' },

   progress_indeterminate_default = { bg = '#393552', fg = '#e0def4' },
   progress_indeterminate_hover   = { bg = '#6e6a86', fg = '#e0def4' },
   progress_indeterminate_active  = { bg = '#c4a7e7', fg = '#e0def4' },
}
