...
-- Retimed from upstream's catppuccin-mocha hexes to rose-pine-moon (gold/rose/foam),
-- matching the color_scheme config/appearance.lua actually sets.
---@type table<string, Cells.SegmentColors>
-- stylua: ignore
local colors = {
   date      = { fg = '#f6c177', bg = 'rgba(0, 0, 0, 0.4)' },
   battery   = { fg = '#ea9a97', bg = 'rgba(0, 0, 0, 0.4)' },
   separator = { fg = '#9ccfd8', bg = 'rgba(0, 0, 0, 0.4)' }
}
