...
-- Retimed from upstream's catppuccin-mocha hexes to rose-pine-moon (text/iris/gold/
-- love/rose), matching the color_scheme config/appearance.lua actually sets.
---@type table<string, Cells.SegmentColors>
-- stylua: ignore
local colors = {
   label_text   = { fg = '#e0def4' },
   icon_default = { fg = '#c4a7e7' },
   icon_wsl     = { fg = '#f6c177' },
   icon_ssh     = { fg = '#eb6f92' },
   icon_unix    = { fg = '#ea9a97' },
}
